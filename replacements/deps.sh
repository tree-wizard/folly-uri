...
mkdir -p _build
cd _build
CXX=clang++-7 CXXFLAGS='-ggdb -fsanitize=fuzzer-no-link,undefined' cmake configure .. -DCMAKE_POSITION_INDEPENDENT_CODE=ON -DFOLLY_USE_SYMBOLIZER=1 -DBUILD_SHARED_LIBS=ON
